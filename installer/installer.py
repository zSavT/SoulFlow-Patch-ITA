...
class WelcomeScreen(QWidget):
    ...
    def __init__(self):
        ...
        title = QLabel("Installer Patch ITA per SoulFlow"); title.setObjectName("TitleLabel"); title.setAlignment(Qt.AlignmentFlag.AlignCenter); title.setWordWrap(True)
...
class InstallScreen(QWidget):
    ...
    def __init__(self):
        ...
        # Etichetta percorso
        path_label = QLabel("Installa la patch nella cartella principale di SoulFlow:"); path_label.setObjectName("SubtitleLabel")

        # Input percorso e bottone sfoglia
        self.path_input = QLineEdit(); self.path_input.setPlaceholderText("Es: C:/.../Steam/steamapps/common/SoulFlow")
    ...
    def set_default_path(self):
        ...
        try:
            ...
            found_base = None
            target_game_folder = "SoulFlow" # Solo il nome della cartella gioco
    ...
    def select_folder(self):
        ...
        # Apri il dialogo
        folder = QFileDialog.getExistingDirectory(self, "Seleziona la cartella principale di SoulFlow", start_dir)
...
class InstallerWizard(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(f"Installer Patch ITA SoulFlow ({VERSIONE})")
    ...
    def confirm_installation(self):
        ...
        executable_full_path = os.path.join(exe_search_path, 'Soulflow.exe')
        ...
        if not found:
            warn_msg = (f"<b>Attenzione:</b> Non è stato possibile trovare 'Soulflow.exe' nel percorso atteso:<br>"
